...
public class CountryPersistenceTest {
	...
	protected OrderByComparator<Country> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "billingAllowed", true, "shippingAllowed", true, "a2", true,
			"a3", true, "number", true, "subjectToVAT", true, "idd", true,
			"zipRequired", true, "position", true, "active", true,
			"groupFilterEnabled", true, "lastPublishDate", true);
	}
