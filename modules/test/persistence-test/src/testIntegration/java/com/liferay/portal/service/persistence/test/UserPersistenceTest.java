...
public class UserPersistenceTest {
	...
	@Test
	public void testCountByCompanyId_Guest() throws Exception {
		_persistence.countByCompanyId_Guest(RandomTestUtil.nextLong());

		_persistence.countByCompanyId_Guest(0L);
	}

	@Test
	public void testCountByCompanyId_DefaultServiceAccount() throws Exception {
		_persistence.countByCompanyId_DefaultServiceAccount(
			RandomTestUtil.nextLong());

		_persistence.countByCompanyId_DefaultServiceAccount(0L);
	}
