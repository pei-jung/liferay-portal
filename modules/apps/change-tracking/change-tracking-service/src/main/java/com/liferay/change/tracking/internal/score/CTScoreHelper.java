 ...
 * @author David Truong
 */
@Component(service = CTScoreHelper.class)
public class CTScoreHelper {
	...
	private static final Log _log = LogFactoryUtil.getLog(CTScoreHelper.class);
