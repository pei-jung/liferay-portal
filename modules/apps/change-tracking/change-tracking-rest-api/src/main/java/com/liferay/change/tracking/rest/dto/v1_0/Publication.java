...
@Generated("")
@GraphQLName(
	description = "A set of changes tracked for a publication.",
	value = "Publication"
)
...
public class Publication implements Serializable {
	...
	public static Publication toDTO(String json) {
		return ObjectMapperUtil.readValue(Publication.class, json);
	}

	public static Publication unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Publication.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.change.tracking.rest.dto.v1_0.Publication",
		name = "x-class-name"
	)
