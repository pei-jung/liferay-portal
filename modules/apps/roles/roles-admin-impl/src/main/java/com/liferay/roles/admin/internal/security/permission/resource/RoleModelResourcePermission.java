...
public class RoleModelResourcePermission
    ...
    @Override
    public void check(
            PermissionChecker permissionChecker, long roleId,
            String actionId)
    ...
    @Override
    public String getModelName() {return Role.class.getName(); }

    @Override
    public PortletResourcePermission getPortletResourcePermission() {return null; }
