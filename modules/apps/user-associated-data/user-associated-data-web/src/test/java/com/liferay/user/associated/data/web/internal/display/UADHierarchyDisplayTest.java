...
public class UADHierarchyDisplayTest {
	...
	public void setUp() {
		DummyUADDisplay<DummyEntry> dummyEntryUADDisplay =
			new DummyUADDisplay<>(DummyEntry.class, _dummyEntryService);
		DummyUADDisplay<DummyContainer> dummyContainerUADDisplay =
			new DummyUADDisplay<>(DummyContainer.class, _dummyContainerService);
	...
	public void testFieldValueCount() {
		List items = _uadHierarchyDisplay.search(
			_USER_ID, null, DummyService.DEFAULT_CONTAINER_ID, "", "createDate",
			"asc", QueryUtil.ALL_POS, QueryUtil.ALL_POS, DummyContainer.class);
	...
	public void testSearch() {
		for (DummyContainer dummyContainer :
			...
			List items = _uadHierarchyDisplay.search(
				_USER_ID, null, dummyContainer.getId(), "", "name", "asc",
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, DummyContainer.class);
