...
public class AnnouncementsFlagUADEntityAggregator
	...
	@Override
	protected AnnouncementsFlag doGetEntity(long entityId)
		throws PortalException {

		return _announcementsFlagLocalService.getAnnouncementsFlag(entityId);
	}

	@Override
	protected long doGetEntityId(AnnouncementsFlag announcementsFlag) {
	...
	@Override
	protected long doGetUserId(AnnouncementsFlag announcementsFlag) {
