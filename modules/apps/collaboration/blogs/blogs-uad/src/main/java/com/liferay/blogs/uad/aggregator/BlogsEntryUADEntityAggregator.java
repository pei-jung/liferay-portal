...
public class BlogsEntryUADEntityAggregator
	...
	@Override
	protected BlogsEntry doGetEntity(long entityId) throws PortalException {
		return _blogsEntryLocalService.getBlogsEntry(entityId);
	}

	@Override
	protected long doGetEntityId(BlogsEntry blogsEntry) {
	...
	@Override
	protected long doGetUserId(BlogsEntry blogsEntry) {
