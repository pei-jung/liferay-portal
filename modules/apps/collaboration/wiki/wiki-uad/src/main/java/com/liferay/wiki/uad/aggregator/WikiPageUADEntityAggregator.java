...
public class WikiPageUADEntityAggregator extends DynamicQueryUADEntityAggregator<WikiPage> {
	@Override
	...
	@Override
	public WikiPage getEntity(Serializable entityId) throws PortalException {
	...
	@Override
	protected List<WikiPage> doGetEntities(DynamicQuery dynamicQuery,
		int start, int end) {
