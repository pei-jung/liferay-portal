...
public class BookmarksFolderUADEntityExporterTest
	...
	public void testExport() throws Exception {
		...
		FileEntry fileEntry = _getFileEntry(
			bookmarksFolder.getCompanyId(), uadEntity.getUADEntityId());

		_verifyFileEntry(fileEntry, bookmarksFolder);
	...
	public void testExportAll() throws Exception {
		...
		BookmarksFolder bookmarksFolderExported = addBookmarksFolder(
			_user.getUserId());
		...
		FileEntry fileEntry = _getFileEntry(
			...
			String.valueOf(bookmarksFolderExported.getFolderId()));

		_verifyFileEntry(fileEntry, bookmarksFolderExported);
	...
	@Test
	public void testExportAllNoBookmarksFolders() throws Exception {
		_uadEntityExporter.exportAll(_user.getUserId());
	}
	...
	private void _verifyFileEntry(
			FileEntry fileEntry, BookmarksFolder bookmarksFolder)
		throws Exception {
		...
		Assert.assertEquals(
			bookmarksFolder.getFolderId(), jsonObject.getInt("folderId"));
	}
