...
renderResponse.setTitle((accountEntryDisplay.getLogoId() == 0) ? LanguageUtil.get(request, "add-account") : LanguageUtil.format(request, "edit-x", accountEntryDisplay.getName(), false));
%>
...
>
	<aui:input name="<%= Constants.CMD %>" type="hidden" value="<%= (accountEntryDisplay.getLogoId() == 0) ? Constants.ADD : Constants.UPDATE %>" />
