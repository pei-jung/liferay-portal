...
>
	...
	<c:if test="<%= !AccountRoleConstants.isSharedRole(role) && AccountRolePermission.contains(permissionChecker, accountRoleDisplay.getAccountRoleId(), ActionKeys.PERMISSIONS) %>">
		<liferay-ui:icon
