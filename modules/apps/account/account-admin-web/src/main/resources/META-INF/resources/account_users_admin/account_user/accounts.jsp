...
<%
SearchContainer accountUserAccountEntryDisplaySearchContainerFactory = AccountUserAccountEntryDisplaySearchContainerFactory.create(liferayPortletRequest, liferayPortletResponse);

accountUserAccountEntryDisplaySearchContainerFactory.setRowChecker(null);
	...
	<div class="sheet sheet-lg">
		...
		<div class="sheet-section">
			<liferay-ui:search-container
				...
				searchContainer="<%= accountUserAccountEntryDisplaySearchContainerFactory %>"
			>
...
<aui:script use="liferay-search-container">
	...
	var searchContainer = Liferay.SearchContainer.get(
		'<portlet:namespace />accountUserAccountEntries'
	);
			...
			Util.selectEntity(
				{
					...
					uri:
						'<portlet:renderURL windowState="<%= LiferayWindowState.POP_UP.toString() %>"><portlet:param name="mvcPath" value="/account_users_admin/select_account_entry.jsp" /><portlet:param name="userId" value='<%= (selUser == null) ? "0" : String.valueOf(selUser.getUserId()) %>' /></portlet:renderURL>'
				},
				function(event) {
