...
public class RedirectURLSettingsImpl implements RedirectURLSettings {
	...
	public String[] redirectURLDomainsAllowed(long companyId) {
		RedirectURLConfiguration redirectURLConfiguration = _getConfig(
			companyId);

		return redirectURLConfiguration.redirectURLDomainsAllowed();
	}
	...
	public String[] redirectURLIPsAllowed(long companyId) {
		...
		return redirectURLConfiguration.redirectURLIPsAllowed();
	}
	...
	public String redirectURLSecurityMode(long companyId) {
		...
		return redirectURLConfiguration.redirectURLSecurityMode();
	}

	private RedirectURLConfiguration _getConfig(long companyId) {
		try {
