...
public abstract class BasePersonalMenuEntry implements PersonalMenuEntry {
	...
	public String getPortletURL(HttpServletRequest request)
		...
		PersonalMenuConfiguration personalMenuConfiguration =
			personalMenuConfigurationTracker.getCompanyConfiguration(
				themeDisplay.getCompanyId());

		String personalApplicationsDisplay =
			personalMenuConfiguration.personalApplicationsDisplay();

		if (personalApplicationsDisplay.equals("current-site")) {
