...
public interface CaptchaConfiguration {
	...
	@Meta.AD(
		...
		description = "captcha-engine-help",
		optionLabels = {"SimpleCaptchaImpl", "ReCaptchaImpl"},
		optionValues = {
	...
	@Meta.AD(name = "recaptcha.public.key.name", required = false)
	public String reCaptchaPublicKey();

	@Meta.AD(name = "recaptcha.private.key.name", required = false)
