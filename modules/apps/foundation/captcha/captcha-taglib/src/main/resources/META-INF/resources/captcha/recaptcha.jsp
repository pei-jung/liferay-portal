...
<%
CaptchaConfiguration captchaConfiguration = CaptchaUtil.getCaptchaConfiguration();
%>
		...
		<div style="height: 525px; width: 302px;">
			<div style="height: 525px; position: relative; width: 302px;">
				<div style="height: 525px; position: absolute; width: 302px;">
					<iframe frameborder="0" scrolling="no" src="<%= PropsValues.CAPTCHA_ENGINE_RECAPTCHA_URL_NOSCRIPT %><%= captchaConfiguration.reCaptchaPublicKey() %>" style="border-style: none; height: 525px; width: 302px;"></iframe>
				</div>
