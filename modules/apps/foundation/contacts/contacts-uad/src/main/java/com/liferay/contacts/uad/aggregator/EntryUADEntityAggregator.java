...
public class EntryUADEntityAggregator extends DynamicQueryUADEntityAggregator<Entry> {
	...
	@Override
	protected Entry doGetEntity(long entityId) throws PortalException {
		return _entryLocalService.getEntry(entityId);
	}

	@Override
	protected long doGetEntityId(Entry entry) {
	...
	@Override
	protected long doGetUserId(Entry entry) {
