...
public class PortalImplEscapeRedirectTest {
	...
	public void testEscapeRedirectWithDomains() throws Exception {
		_redirectURLSettingsImpl.redirectURLSecurityMode = "domain";
		_redirectURLSettingsImpl.redirectURLDomainsAllowed = new String[] {
	...
	public void testEscapeRedirectWithIPs() throws Exception {
		...
		_redirectURLSettingsImpl.redirectURLSecurityMode = "ip";
		_redirectURLSettingsImpl.redirectURLIPsAllowed = new String[] {
			"127.0.0.1", "SERVER_IP"
		};
	...
	private static class RedirectURLSettingsImpl
		...
		@Override
		public String[] redirectURLDomainsAllowed(long companyId) {
			return GetterUtil.getStringValues(redirectURLDomainsAllowed);
		}

		@Override
		public String[] redirectURLIPsAllowed(long companyId) {
			return GetterUtil.getStringValues(redirectURLIPsAllowed);
		}

		@Override
		public String redirectURLSecurityMode(long companyId) {
			return GetterUtil.getString(redirectURLSecurityMode);
		}

		protected String[] redirectURLDomainsAllowed;
		protected String[] redirectURLIPsAllowed = {"127.0.0.1", "SERVER_IP"};
		protected String redirectURLSecurityMode = "ip";
