...
public class UserPersistenceImpl
	...
	private FinderPath _finderPathFetchByCompanyId_Guest;
	private FinderPath _finderPathCountByCompanyId_Guest;

	/**
	 * Returns the user where companyId = &#63; or throws a <code>NoSuchUserException</code> if it could not be found.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public User findByCompanyId_Guest(long companyId)
		throws NoSuchUserException {

		User user = fetchByCompanyId_Guest(companyId);
	...
	/**
	 * Returns the user where companyId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param companyId the company ID
	 * @return the matching user, or <code>null</code> if a matching user could not be found
	 */
	@Override
	public User fetchByCompanyId_Guest(long companyId) {
		return fetchByCompanyId_Guest(companyId, true);
	}

	/**
	 * Returns the user where companyId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param companyId the company ID
	 * @param useFinderCache whether to use the finder cache
	 * @return the matching user, or <code>null</code> if a matching user could not be found
	 */
	@Override
	public User fetchByCompanyId_Guest(long companyId, boolean useFinderCache) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			User.class);
		...
		if (useFinderCache && productionMode) {
			result = FinderCacheUtil.getResult(
				_finderPathFetchByCompanyId_Guest, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_COMPANYID_GUEST_COMPANYID_2);
				...
				if (list.isEmpty()) {
					if (useFinderCache && productionMode) {
						FinderCacheUtil.putResult(
							_finderPathFetchByCompanyId_Guest, finderArgs,
							list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"UserPersistenceImpl.fetchByCompanyId_Guest(long, boolean) with parameters (" +
	...
	/**
	 * Removes the user where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @return the user that was removed
	 */
	@Override
	public User removeByCompanyId_Guest(long companyId)
		throws NoSuchUserException {

		User user = findByCompanyId_Guest(companyId);
	 ...
	 */
	@Override
	public int countByCompanyId_Guest(long companyId) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			User.class);
		...
		if (productionMode) {
			finderPath = _finderPathCountByCompanyId_Guest;
	...
	private static final String _FINDER_COLUMN_COMPANYID_GUEST_COMPANYID_2 =
		"user.companyId = ? AND type_ = 0";

	private FinderPath _finderPathFetchByCompanyId_DefaultServiceAccount;
	private FinderPath _finderPathCountByCompanyId_DefaultServiceAccount;
	 ...
	 */
	@Override
	public User findByCompanyId_DefaultServiceAccount(long companyId)
		throws NoSuchUserException {

		User user = fetchByCompanyId_DefaultServiceAccount(companyId);
	 ...
	 */
	@Override
	public User fetchByCompanyId_DefaultServiceAccount(long companyId) {
		return fetchByCompanyId_DefaultServiceAccount(companyId, true);
	}
	 ...
	 */
	@Override
	public User fetchByCompanyId_DefaultServiceAccount(
		...
		if (useFinderCache && productionMode) {
			result = FinderCacheUtil.getResult(
				_finderPathFetchByCompanyId_DefaultServiceAccount, finderArgs,
				this);
		}
		...
		if (result == null) {
			...
			sb.append(
				_FINDER_COLUMN_COMPANYID_DEFAULTSERVICEACCOUNT_COMPANYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache && productionMode) {
						FinderCacheUtil.putResult(
							_finderPathFetchByCompanyId_DefaultServiceAccount,
							finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"UserPersistenceImpl.fetchByCompanyId_DefaultServiceAccount(long, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	 ...
	 */
	@Override
	public User removeByCompanyId_DefaultServiceAccount(long companyId)
		throws NoSuchUserException {

		User user = findByCompanyId_DefaultServiceAccount(companyId);
	 ...
	 */
	@Override
	public int countByCompanyId_DefaultServiceAccount(long companyId) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			User.class);
		...
		if (productionMode) {
			finderPath = _finderPathCountByCompanyId_DefaultServiceAccount;
	...
	public void cacheResult(User user) {
		...
		FinderCacheUtil.putResult(
			_finderPathFetchByCompanyId_Guest,
			new Object[] {user.getCompanyId()}, user);
	...
	protected void cacheUniqueFindersCache(UserModelImpl userModelImpl) {
		Object[] args = new Object[] {userModelImpl.getCompanyId()};

		FinderCacheUtil.putResult(
			_finderPathCountByCompanyId_Guest, args, Long.valueOf(1));
		FinderCacheUtil.putResult(
			_finderPathFetchByCompanyId_Guest, args, userModelImpl);

		args = new Object[] {userModelImpl.getCompanyId()};

		FinderCacheUtil.putResult(
			_finderPathCountByCompanyId_DefaultServiceAccount, args,
			Long.valueOf(1));
		FinderCacheUtil.putResult(
			_finderPathFetchByCompanyId_DefaultServiceAccount, args,
			userModelImpl);

		args = new Object[] {userModelImpl.getContactId()};
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByCompanyId_Guest = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByCompanyId_Guest",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			true);

		_finderPathCountByCompanyId_Guest = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId_Guest",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			false);

		_finderPathFetchByCompanyId_DefaultServiceAccount = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByCompanyId_DefaultServiceAccount",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			true);

		_finderPathCountByCompanyId_DefaultServiceAccount = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByCompanyId_DefaultServiceAccount",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			false);
