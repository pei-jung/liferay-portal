...
public class PortletPreferencesLocalServiceImpl
	...
	public Settings getPortletInstanceSettings(
		...
		Settings companyConfigurationBeanSettings =
			settingsLocatorHelper.getCompanyConfigurationBeanSettings(
		...
		Settings groupConfigurationBeanSettings =
			settingsLocatorHelper.getGroupConfigurationBeanSettings(
		...
		Settings portletInstanceConfigurationBeanSettings =
			settingsLocatorHelper.getPortletInstanceConfigurationBeanSettings(
				portletId, configurationPid, groupPortletPreferencesSettings);
