...
<liferay-ui:error exception="<%= RequiredStructureException.MustNotDeleteReferencedStructure.class %>" message="cannot-delete-a-document-type-that-is-presently-used-by-one-or-more-documents" />
