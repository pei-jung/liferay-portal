...
<liferay-ui:error exception="<%= RequiredStructureException.MustNotDeleteReferencedFileEntryType.class %>" message="cannot-delete-a-document-type-that-is-presently-used-by-one-or-more-documents" />
